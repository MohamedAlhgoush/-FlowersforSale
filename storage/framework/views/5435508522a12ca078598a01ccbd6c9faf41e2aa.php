...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/Estyle.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/Astyle.css')); ?>">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@700&display=swap" rel="stylesheet">
    <!-- <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"> -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
    <script src="<?php echo e(asset('assets/js/jquery-1.11.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/moment-2.2.1.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/script.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/clndr.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/site.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/underscore-min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/jClocksGMT.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/jquery.rotate.js')); ?>"></script>
    <link href="<?php echo e(asset('assets/lib/main.css')); ?>" rel='stylesheet' />
    <script src="<?php echo e(asset('assets/lib/main.js')); ?>"></script>
    <script>
        ...
        <div class="container">
            ...
            <form class="form-row1 mx-0">
                ...
                <a class="nav-link micro_show" id="micro" href="/order"><img
                        src="<?php echo e(asset('assets/images/bag12.png')); ?>" class="svg_img_bag" alt="">
                    <?php if(Cart::count() > 0): ?>
                        <span class="nb_order"><?php echo e(Cart::count()); ?></span>
                    <?php endif; ?>
                </a>
...
} elseif ($_instance->childHasBeenRendered('SXzcJXg')) {
    $componentId = $_instance->getRenderedChildComponentId('SXzcJXg');
    $componentTag = $_instance->getRenderedChildComponentTagName('SXzcJXg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SXzcJXg');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('SXzcJXg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="d2">
                    ...
                    <?php if(Route::has('login')): ?>
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="/order"><img src="<?php echo e(asset('assets/css/bag(1).svg')); ?>"
        ...
        <div class="sidebar">
            <div class="header_sidebar">
                ...
                <ul class="list_sidebar">
                    <li>
                        <a><img src="<?php echo e(asset('assets/images/track.png')); ?>">TRACK ORDER</a>
                    </li>
                </ul>
            </div>
            <ul class="nav_sidebar">
                <li>
                    <a href="/">
                        <img src="<?php echo e(asset('assets/images/menu.png')); ?>" alt=""> menue
                        <span>
                ...
                <li>
                    <a href="/branches">
                        <img src="<?php echo e(asset('assets/images/location.png')); ?>" alt=""> branches
                        <span>
                            <i arial-hidden="true" class="fa fa-angle-right"></i>
                        </span>
                    </a>
                ...
                <li>
                    <a href="/aboutus">
                        <img src="<?php echo e(asset('assets/images/information-button.png')); ?>" alt=""> About us
                        <span>
                            <i arial-hidden="true" class="fa fa-angle-right"></i>
                        </span>
                    </a>
                ...
                <li>
                    <a href="<?php echo e(route('login')); ?>">
                        <img src="<?php echo e(asset('assets/images/login.png')); ?>" alt=""> login
                        <span>
                            <i arial-hidden="true" class="fa fa-angle-right"></i>
                        </span>
                    </a>
        ...
        <script>
            window.jQuery || document.write('<script src="<?php echo e(asset('assets/js/jquery-2.1.4.js')); ?>"><\/script>');
...
<?php /**PATH C:\xampp\htdocs\Ecommerce-k\resources\views/layouts/base.blade.php ENDPATH**/ ?>