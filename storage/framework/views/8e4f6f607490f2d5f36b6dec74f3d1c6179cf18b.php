...
<body>
    ...
    <nav class="fixed-top navbar navbar-expand-lg p-0" id="nav1">
        <div class="container">
            <a class="navbar-brand " href="/" id="gate">Gate of Flowers</a>
                ...
                <div class="row">
                    <div class="text-center atribution col-md-12">
                        <ul>
                            ...
                            <li>
                                <a href="/orderstatus">orederd status</a>
                            </li>
                            <li>
                                <a href="/aboutus">about us</a>
                            </li>
                            <li>
                                <a href="/branches">contact us</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Ecommerce-k\resources\views/layouts/guest.blade.php ENDPATH**/ ?>